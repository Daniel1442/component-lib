...
const ModalWrapper: React.FC<ComponentProps> = ({
    ...
    return <div className={`modal fade show ${size}`} aria-modal="true" role="dialog"
        ...
        <div
            ...
            ref={ref}>
            <div className={`modal-content modal-rounded ${hAuto && 'h-auto'} position-relative ${modalClassName}`}
                 style={modalStyle}>
